...
CoolantOutletTemperature = 536.0 + 273.15 #"C" # Set or calculated PEAK coolant outlet temperature [K or "C"]
...
MetallicFuelNonActinideMassFraction = 0 # Fraction of metallic alloy fuel (MetallicZr or MetallicMo) that is the alloying element [#]
...
## FLOW CONSTRAINTS
PressureDropConstraint               = 1.38e6 # Total primary cycle pressure drop constraint [Pa]
...
SerpentVersion = 1 # Version of Serpent to run [1 or 2]

## PARALLELIZATION SETTINGS
SerpentParallelization = "on" # Run Serpent in parallell ["off" / "mpi" / "openmp"]
